...
#define T 20000  // number of timesteps
...
///* FILE I/0 SETUP */
    ...
    FILE *fpOutPsi;
    FILE *fpOutPhi;
    fpInit = fopen("./Data files/Initial states/(8-13-15)IntermediateAttractiveInitial.txt","r");   // initial conditions
    fpOutPsi = fopen("./Data files/Stable state parameter exploration/(9-23-15.1)IntermediateAttractivePsi.txt","w+");    // data output file for psi
